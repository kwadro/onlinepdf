...
class MenuTypeCrudController extends AbstractCrudController
{
    ...
    public static function getEntityFqcn(): string { return MenuType::class; }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            AssociationField::new('menuitems')->setFormTypeOption('by_reference', false),
        ];
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_menutype_single', [], 'messages');
         return $crud
