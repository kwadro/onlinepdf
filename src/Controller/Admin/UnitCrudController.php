...
class UnitCrudController extends AbstractCrudController
{
    ...
    public static function getEntityFqcn(): string { return Unit::class; }
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_unit_single', [], 'messages');
         return $crud
