...
class FooterCrudController extends AbstractCrudController
{
    ...
    public static function getEntityFqcn(): string { return Footer::class; }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextareaField::new('content')->setHelp('Enter full text here')->setNumOfRows('3')->hideOnIndex(),
        
            TextareaField::new('content_uk')->setHelp('Enter full text here')->setNumOfRows('3')->hideOnIndex(),
        ];
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_footer_single', [], 'messages');
         return $crud
