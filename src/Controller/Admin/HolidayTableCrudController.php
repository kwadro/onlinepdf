...
use App\Form\Type\HolidayTableRecipeType;
...
class HolidayTableCrudController extends AbstractCrudController
{
    public function __construct(
        private TranslatorInterface $translator
    ) {
    }
    public static function getEntityFqcn(): string { return HolidayTable::class; }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            IntegerField::new('men_count')
                ->setFormTypeOption('attr', ['min' => 0, 'max' => 1000])
                ->setHelp('Enter a positive number only'),
            IntegerField::new('women_count')
                ->setFormTypeOption('attr', ['min' => 0, 'max' => 1000])
                ->setHelp('Enter a positive number only'),
            CollectionField::new('holidaytablerecipes')
                ->setEntryType(HolidayTableRecipeType::class)
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_holidaytable_single', [], 'messages');
         return $crud
            ->setFormThemes([
