...
class EmailMailboxFolderCrudController extends AbstractCrudController
{
    public function __construct(
        private TranslatorInterface $translator
    ) {
    }
    public static function getEntityFqcn(): string { return EmailMailboxFolder::class; }

    public function configureFields(string $pageName): iterable
    {
        return [
            IdField::new('id')->hideOnForm(),
            AssociationField::new('emailmailbox'),
            AssociationField::new('emailmessages')->setFormTypeOption('by_reference', false),
            TextField::new('foldername')->setRequired(true),
            ChoiceField::new('folderactive')->setChoices(['Yes' => 'Yes', 'No' => 'No']),
        ];
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_emailmailboxfolder_single', [], 'messages');
         return $crud
            ->setFormThemes([
