...
class RecipeStepCrudController extends AbstractCrudController
{
    ...
    public static function getEntityFqcn(): string { return RecipeStep::class; }
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_recipestep_single', [], 'messages');
         return $crud
