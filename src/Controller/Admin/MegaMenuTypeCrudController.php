...
class MegaMenuTypeCrudController extends AbstractCrudController
{
    public function __construct(
        private TranslatorInterface $translator
    ) {
    }
    public static function getEntityFqcn(): string { return MegaMenuType::class; }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            AssociationField::new('megamenutranslations')->setFormTypeOption('by_reference', false),
        ];
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_megamenutype_single', [], 'messages');
         return $crud
