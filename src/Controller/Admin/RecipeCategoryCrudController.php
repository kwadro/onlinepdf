...
class RecipeCategoryCrudController extends AbstractCrudController
{
    ...
    public static function getEntityFqcn(): string { return RecipeCategory::class; }
