...
class PopularsearchCrudController extends AbstractCrudController
{
    public function __construct(
        private TranslatorInterface $translator
    ) {
    }
    public static function getEntityFqcn(): string { return Popularsearch::class; }
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_popularsearch_single', [], 'messages');
         return $crud
            ->setFormThemes([
