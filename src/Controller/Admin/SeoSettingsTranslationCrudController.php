...
class SeoSettingsTranslationCrudController extends AbstractCrudController
{
    public function __construct(
        private TranslatorInterface $translator
    ) {
    }
    public static function getEntityFqcn(): string { return SeoSettingsTranslation::class; }
    ...
    public function configureActions(Actions $actions): Actions
    {
          $export = Action::new('exportCsv', $this->translator->trans('menu.link_export_csv', [], 'messages'))
                      ->linkToRoute('admin_export_csv', ['entity' => 'SeoSettingsTranslation'])
                      ->createAsGlobalAction()
                      ->addCssClass('btn btn-secondary')
                      ->setIcon('fa fa-file-csv');
          $import = Action::new('import', $this->translator->trans('menu.link_import_csv', [], 'messages'))
                       ->linkToRoute('admin_import', ['entity' => 'SeoSettingsTranslation'])
                       ->createAsGlobalAction()
                       ->addCssClass('btn btn-secondary')
