...
class FooterSettingCrudController extends AbstractCrudController
{
    public function __construct(
        private TranslatorInterface $translator
    ) {
    }
    public static function getEntityFqcn(): string { return FooterSetting::class; }
    ...
    public function configureCrud(Crud $crud): Crud
    {
         ...
         $linkName = $this->translator->trans('menu.link_footersetting_single', [], 'messages');
         return $crud
