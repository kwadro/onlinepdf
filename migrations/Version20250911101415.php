 ...
 */
final class Version20250911101415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_access (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, server_type VARCHAR(255) NOT NULL, INDEX IDX_633B3069A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
